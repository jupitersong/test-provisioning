...
# Please change "jy" to what you want to use
# d after name indicates develop. This means that jyd_apnortheast2 VPC is for development environment VPC in Seoul Region.
vpc_name = "jyd_apnortheast2"
...
shard_id = "jydapne2"
shard_short_id = "jy01d"

# d means develop
env_suffix = "d"

# VPC Peering Connection Variables
vpc_peer_connection_id_jyp_apne2 = "pcx-"
jyp_destination_cidr_block = "10.20.0.0/16"
